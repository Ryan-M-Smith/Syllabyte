      ...
      <header className="border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-20">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link
              href="/"
              className="text-slate-400 hover:text-navy-700 transition-colors text-sm"
            >
              ← Back
            </Link>
          ...
          {messages.length === 0 && (
            <div className="text-center py-20 animate-fade-up">
              ...
              <p className="text-sm text-slate-400 mb-10">
                ...
                <span className="font-mono font-semibold text-navy-700">{courseId}</span>
              </p>
      ...
      <div className="border-t border-slate-200 bg-white/80 backdrop-blur-md sticky bottom-0">
        <div className="max-w-3xl mx-auto px-4 py-4">
          ...
          <p className="text-[10px] text-slate-400 mt-2 text-center">
            Syllabyte · Powered by Gemini 3.1 Pro via OpenClaw on Raspberry Pi
          </p>
        </div>
      </div>
    </div>
