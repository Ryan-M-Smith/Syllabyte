  ...
  return (
    <div className="min-h-screen relative grain">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-150 h-150 rounded-full bg-ember-100 opacity-40 blur-[120px] -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-125 h-125 rounded-full bg-sea-100 opacity-30 blur-[100px] translate-y-1/3 -translate-x-1/4" />
      </div>
