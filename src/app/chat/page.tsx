            ...
            >
              {msg.role === "user" ? (
                ...
                <div className="flex gap-3 max-w-[90%]">
                  <div className="w-7 h-7 rounded-lg bg-ember-100 flex items-center justify-center shrink-0 mt-1">
        ...
        <div className="max-w-3xl mx-auto px-4 py-4">
          <div className="flex items-end gap-3">
            ...
            <button
              ...
              className="w-11 h-11 rounded-xl bg-claw-900 text-claw-50 flex items-center justify-center hover:bg-claw-700 disabled:opacity-30 disabled:cursor-not-allowed transition-all cursor-pointer shrink-0"
            >
              <svg
                width="18"
                height="18"
